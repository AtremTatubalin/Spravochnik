...
private fun formula(id: String, inputs: Map<String, String>, outputs: Map<String, String>, assumptions: List<String> = emptyList(), warnings: List<String> = emptyList(), block: (Map<String, Double>) -> Map<String, Double>): FormulaDefinition = KotlinFormula(id, 1, inputs, outputs, assumptions, warnings, emptyList(), "automatic", block)
